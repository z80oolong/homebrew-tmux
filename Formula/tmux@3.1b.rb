...
index be0d220..cf902b2 100644
--- a/options-table.c
+++ b/options-table.c
@@ -804,6 +804,29 @@ const struct options_table_entry options_table[] = {
 	  .default_num = 1
 	},
...
+#endif
 	...
 	setlocale(LC_TIME, "");
 	tzset();
@@ -356,6 +365,13 @@ main(int argc, char **argv)
