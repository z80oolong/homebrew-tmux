...
--- a/options-table.c
+++ b/options-table.c
@@ -770,5 +770,37 @@ const struct options_table_entry options_table[] = {
 	  .default_num = 1
 	},
...
+#endif
 	...
 	setlocale(LC_TIME, "");
 	tzset();
@@ -351,6 +360,21 @@ main(int argc, char **argv)
...
index d7f3819..7d5873a 100644
--- a/tmux.h
+++ b/tmux.h
@@ -66,6 +66,17 @@ struct winlink;
