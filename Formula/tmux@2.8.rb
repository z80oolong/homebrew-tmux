...
index 2b6b794..e597952 100644
--- a/options-table.c
+++ b/options-table.c
@@ -941,5 +941,28 @@ const struct options_table_entry options_table[] = {
 	  .default_num = 1
 	},
...
index f81c93c..db6c2a0 100644
--- a/tty-term.c
+++ b/tty-term.c
@@ -512,6 +512,15 @@ tty_term_find(char *name, int fd, char **cause)
...
+#else
 	...
 	memset(term->acs, 0, sizeof term->acs);
 	if (tty_term_has(term, TTYC_ACSC))
@@ -520,6 +529,7 @@ tty_term_find(char *name, int fd, char **cause)
