class Tmux < Formula
  ...
  if build.head? || build.devel?
    patch do
      url "https://raw.githubusercontent.com/z80oolong/diffs/master/tmux/tmux-HEAD-9da78d72-fix.diff"
      sha256 "ab660a72fdd45ae9c7c3aed3639a7a58e56405e49853941c7877c2650fe31b01"
    end
  else
    patch do
