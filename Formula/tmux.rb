class Tmux < Formula
  ...
  head do
    ...
    patch do
      url "https://github.com/z80oolong/tmux-eaw-fix/raw/master/tmux-HEAD-2534aa4d-fix.diff"
      sha256 "c4af38b8e60bbad2ecc6b9fa210232415ee7d2273fb0dd4a819ccde7796e7123"
    end
