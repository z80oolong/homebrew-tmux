class Tmux < Formula
  ...
  head do
    ...
    patch do
      url "https://raw.githubusercontent.com/z80oolong/diffs/master/tmux/tmux-HEAD-1c5093c1-fix.diff"
      sha256 "9621e72788a4a9a6bba21d74fc74937a363b2435c77900a4b69171b1ccda5be2"
    end
