class Tmux < Formula
  ...
  head do
    ...
    patch do
      url "https://raw.githubusercontent.com/z80oolong/diffs/master/tmux/tmux-HEAD-cd8a7fb0-fix.diff"
      sha256 "feb20891397b223fe35d57ee7b485466cfda65687aa67d4662149e870a0f79fd"
    end
