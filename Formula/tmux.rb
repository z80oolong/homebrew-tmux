class Tmux < Formula
  ...
  head do
    ...
    patch do
      url "https://github.com/z80oolong/tmux-eaw-fix/raw/master/tmux-HEAD-7323ffee-fix.diff"
      sha256 "1b4bfde4e32adcaba467953f82c563823f0acd9132a0fd7aba6ece172528a1e2"
    end
