class Tmux < Formula
  ...
  head do
    ...
    patch do
      url "https://github.com/z80oolong/tmux-eaw-fix/raw/master/tmux-HEAD-a01c9ffc-fix.diff"
      sha256 "4d3e4ea9d4ed4cc1442a5c9409c419d11b82b7db4718d1a067aa8523f82b28ea"
    end
