...
class Tmux < Formula
  ...
  stable do
    ...
    patch :p1, Formula["z80oolong/tmux/tmux@3.4"].diff_data
  end
  ...
  option "without-sixel", "Build without enable SIXEL Graphics."
  ...
  def install
    ...
    args << "--enable-sixel"    unless build.without?("sixel")
...
index 37fab549..72b11559 100644
--- a/options-table.c
+++ b/options-table.c
@@ -1287,6 +1287,38 @@ const struct options_table_entry options_table[] = {
...
index 197af2c6..0f28fd03 100644
--- a/tmux.h
+++ b/tmux.h
