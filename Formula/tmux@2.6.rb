...
index 00ee33b1..4ca1697b 100644
--- a/cfg.c
+++ b/cfg.c
@@ -72,6 +72,10 @@ start_cfg(void)
 	int		 quiet = 0;
 	struct client	*c;
...
index f5e973e5..aeca9754 100644
--- a/options-table.c
+++ b/options-table.c
@@ -935,5 +935,37 @@ const struct options_table_entry options_table[] = {
 	  .default_num = 1
 	},
...
index 78cb499b..287e0559 100644
--- a/tmux.c
+++ b/tmux.c
@@ -190,18 +190,27 @@ main(int argc, char **argv)
 {
 	char					*path, *label, **var;
 	char					 tmp[PATH_MAX];
+#ifndef NO_USE_UTF8CJK
...
index adc020d5..73bf63c0 100644
--- a/tmux.h
+++ b/tmux.h
...
index 1f7a2b11..059d0cdb 100644
--- a/tty-acs.c
+++ b/tty-acs.c
@@ -22,6 +22,83 @@
...
index 9d026fa3..23e6db55 100644
--- a/tty-term.c
+++ b/tty-term.c
...
index a91da360..68100315 100644
--- a/utf8.c
+++ b/utf8.c
@@ -25,6 +25,407 @@
